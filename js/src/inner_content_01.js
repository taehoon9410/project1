...
(function($) {
  ...
  06-1. prependTo()    주어 순서만 바뀜.
  07. append()     : 선택요소의 자식의 뒤에 요소를 제작/삽입하는 메소드
  07-1 appendTo()    주어 순서만 바뀜.
...
*/
 ...
 // var text = ['네이버', '다음' , '구글' , '비핸스','핀터레스트','드리블리'];
 // var link = [
 //             'http://naver.com',
 //             'http://daum.net',
 //             'http://google.com',
...
var productList = [
{color:'#ff0',text:'네이버'     ,link: 'http://naver.com'},
{color:'#cca',text:'다음'       ,link:'http://daum.net'},
{color:'#acf',text:'구글'       ,link:'http://google.com'},
{color:'#f06',text:'비핸스'     ,link:'http://behance.net'},
{color:'#f7f',text:'핀터레스트'  ,link:'http://pinterest.com'},
{color:'#afa',text:'드리블리'   ,link:'http://dribbble.com'}
